...
const PageServices = () => (
  <div id="pages-services" className="container">
    <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3">

      <div className="col card-wrapper">
        <div className="example-1 card">
          <div className="wrapper">
            <img src="https://bbltech.com/wp-content/uploads/2021/01/web.png" className="card-img-top" />
            <div className="date">
      ...
      <div className="col card-wrapper">
        <div className="example-1 card">
          <div className="wrapper">
            <img src="https://bbltech.com/wp-content/uploads/2021/01/app.png" className="card-img-top" />
            <div className="date">
      ...
      <div className="col card-wrapper">
        <div className="example-1 card">
          <div className="wrapper">
            <img src="https://bbltech.com/wp-content/uploads/2021/01/fb.png" className="card-img-top" />
            <div className="date">
      ...
      <div className="col card-wrapper">
        <div className="example-1 card">
          <div className="wrapper">
            <img src="https://bbltech.com/wp-content/uploads/2021/01/edm.png" className="card-img-top" />
            <div className="date">
      ...
      <div className="col card-wrapper">
        <div className="example-1 card">
          <div className="wrapper">
            <img src="https://bbltech.com/wp-content/uploads/2021/01/sln.png" className="card-img-top" />
            <div className="date">
      ...
      <div className="col card-wrapper">
        <div className="example-1 card">
          <div className="wrapper">
            <img src="https://bbltech.com/wp-content/uploads/2021/01/maint.png" className="card-img-top" />
            <div className="date">
